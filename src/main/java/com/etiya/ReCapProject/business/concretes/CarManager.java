...
public class CarManager implements CarService {
	...
	public DataResult<List<CarDetailDto>> getCarsByCity_CityId(int cityId) {
		...
		for (Car car : cars) {
			...
			carDetailDto.setBrandDetailDto(this.brandService.getBrandDetailById(car.getBrand().getBrandId()).getData());
			carDetailDto.setColorDetailDto(this.colorService.getColorDetailById(car.getColor().getColorId()).getData());
			carDetailDto.setCityDetailDto(this.cityService.getCityDetailById(car.getCity().getCityId()).getData());
			carDetailDto.setCarImageDetailDtos(this.carImageService.getCarImageDetailByCarId(car.getCarId()).getData());
